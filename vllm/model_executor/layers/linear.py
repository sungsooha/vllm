...
class QKVParallelLinear(ColumnParallelLinear):
    ...
    def __init__(
        ...
        *,
        ...
        # Divide the weight matrix along the head dimension. TPA can use a
        # smaller TP width for attention than the full ColumnParallel shard
        # count used to store the concatenated QKV projection.
