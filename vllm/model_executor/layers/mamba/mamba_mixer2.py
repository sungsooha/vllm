    ...
    **selective** state spaces)
    ...
    def conv_ssm_forward(
        ...
        if is_mamba_cache_all:
            ...
            # num_decodes + num_prefills. Use tensor size minus num_prefills
            ...
            block_idx_last_computed_token_d, block_idx_last_computed_token_p = (
                torch.split(
                    ...
                    [_block_last_computed.shape[0] - num_prefills, num_prefills],
                    dim=0,
                )
            )
            ...
            block_idx_last_scheduled_token_d, block_idx_last_scheduled_token_p = (
                torch.split(
                    ...
                    [_block_last_scheduled.shape[0] - num_prefills, num_prefills],
                    dim=0,
                )
            )
