...
class _ColumnvLLMParameter(BasevLLMParameter):
    ...
    def load_qkv_weight(self, loaded_weight: torch.Tensor, **kwargs):
        ...
        # TPA (per-layer parallelism v1): honor an explicit tp_rank kwarg
        # passed by QKVParallelLinear (the attention-TP rank under TPA<TP);
        # fall back to self.tp_rank (the full TP rank) when unset.
