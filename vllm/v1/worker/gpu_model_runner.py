...
class GPUModelRunner(
    ...
    def __init__(
        ...
        self._init_total_cp_world_sizes: list[int] = []
        self._init_total_cp_ranks: list[int | None] = []
